...
# 
# * [Wunder an Präzision](#SubSec-Wunder_an_Präzision)
# 
# ### [Einheiten](#Sec-Einheiten)
# 
# * [Historie der Einheiten](#SubSec-Historie_der_Einheiten)
# * [Das International Einheitensystem](#SubSec-Das_International_Einheitensystem)
# * [Definition über Naturkonstanten](#SubSec-Definition_über_Naturkonstanten)
# * [Abgeleitete / Ergänzende SI-Einheiten](#SubSec-Abgeleitete_Ergänzende_SI-Einheiten)
# * [Nicht-Si-Einheiten](#SubSec-Nicht-Si-Einheiten)
# * [Vorsätze und Präfix im SI](#SubSec-Vorsätze_und_Präfix_im_SI)
# * [Logarithmische Einheiten](#SubSec-Logarithmische_Einheiten)
# 
# ### [Kalibrieren und Eichen (und Prüfen)](#Sec-Kalibrieren_und_Eichen_und_Prüfen)
# 
# * [Kalibrieren und Eichen](#SubSec-Kalibrieren_und_Eichen)
# * [Normale](#SubSec-Normale)
# 
...
Image("pictures/temp.png", width=500)
...
Image("pictures/block1.png", width=500)


# Wie man an der oben dargestellten Temperaturmessung sieht, sind die Werte, die gemessen werden, nicht unbedingt *exakt*. Später befassen wir uns noch mal genauer mit den so genannten **Messabweichungen**, doch ein Beispiel soll schon mal im nächsten Abschnitt gegeben werden. 

# ### Wunder an Präzision (2600 v. Chr.)
# <a id="SubSec-Wunder_an_Präzision"></a>
# 
...
Image("pictures/massstab.png", width=850)
...
# ## Einheiten
# <a id="Sec-Einheiten"></a>
# 
# ### Historie der Einheiten
# <a id="SubSec-Historie_der_Einheiten"></a>
# 
...
Image("pictures/meter.png", width=350)
...
Image("pictures/SI.png", width=300)
...
Image("pictures/ur-kilo.png", width=1000)


# Image("pictures/SI.png", width=300)### Definition über Naturkonstanten
# <a id="SubSec-Definition_über_Naturkonstanten"></a>
# 
...
Image("pictures/SI-konst.png", width=1000)
...
# <a id="SubSec-Vorsätze_und_Präfix_im_SI"></a>
# 
...
Image("pictures/praefix.png", width=500)
...
# 
# Ein Veranschaulichung der Größen findet man zum Beispiel [hier: https://www.htwins.net/scale2/](https://www.htwins.net/scale2/)
...
# **Beispiel-Plots:**
# 
# * Erster Plot: Verteilung der Beitragszahlen der aktivsten Autoren in der deutschsprachigen Wikipedia
# * Zweiter Plot: Dieselbe Verteilung in einfacher logarithmischer Darstellung (y-Achse)
# * Dritter Plot: Dieselbe Verteilung in doppelt logarithmischer Darstellung (x- und y-Achse)
# 
# Quelle: [https://de.wikipedia.org/wiki/Logarithmische_Darstellung](https://de.wikipedia.org/wiki/Logarithmische_Darstellung)

# In[11]:


Image("pictures/log_no.png", width=300)


# In[12]:


Image("pictures/log_y.png", width=300)


# In[13]:


Image("pictures/log_xy.png", width=300)
...
Image("pictures/kalibrieren.png", width=800)
...
Image("pictures/normale.png", width=800)
...
Image("pictures/zusammenfassung_1.png", width=800)
