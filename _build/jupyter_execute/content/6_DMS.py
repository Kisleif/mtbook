...
# Aus diesem Grund werden DMSs häufig Widerstands-Messbrücken verwendet. Mittels verschiedenen Anordnungen können damit auch Querkräfte, Scherkräfte und andere Belastungen gemessen werden und Kompensation in Bezug auf Temperaturempfindlichkeiten können dadurch eliminiert werden {cite}`parthier2020`. 
...
# Eine eleganten Zusammensatzung wäre ein n- und p-dotierter Silizium-DMS mit jeweils dem gleichen, aber entgegengesetzten $k$-Faktor, welche in einer Messbrücke zusammengeschaltet werden {cite}`boettcher2020`. 

# ### Biegungsbeanspruchung
# 
# Es gibt verschiedene Möglicheiten DMS zur Kraftmessung zu nutzen. Die Sensoren können beispielsweise an einen Biegebalken angebracht werden, wie es in {numref}`dms_bieg_mess` dargestellt ist, wodurch man die **Biegung** des Körpers messen kann.
# 
...
# 
# Typischerweise können Kräfte von 1-50 kN gemessen werden {cite}`parthier2020`. 
# 
# 
# ### Zug und Druck
# 
